...
export default function Stream({key, title, creator, emergency, id}: any) {
  ...
  return (
    <div className={'relative -z-50 flex flex-col rounded-xl border-2 bg-[#B0C0D4] duration-300 hover:scale-105'} key={key}>
      <div
      ...
      <div className={'mt-auto flex flex-row justify-between gap-4 overflow-x-auto rounded-b-xl bg-white p-2'}>
