...
export default function NavBarConnected() {
  ...
  const handleSubMenu = () => {
    ...
    return (
        <div
            className={
                'z-10 fixed overflow-hidden max-md:w-full max-md:h-24 mt-0 flex h-screen w-1/6 md:flex-col items-center bg-[#394054] max-md:fixed max-md:bottom-0 max-md:items-center'
            }
        >
