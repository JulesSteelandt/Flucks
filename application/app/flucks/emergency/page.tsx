...
export default function emergencyWarning() {
  ...
  return (
    <div className={'flex h-full w-full flex-col items-center justify-center md:w-5/6'}>
      ...
      >
        <div className={'flex w-full rounded-t-lg bg-[#5DA5B3] py-6'}>
          <div
            className={'ml-4 flex h-12 min-h-12 w-12 min-w-12 items-center justify-center rounded-full bg-[#A91208]'}
          >
            <p className={'text-center text-3xl text-white'}>!</p>
          </div>

          <p className={'mx-4 max-w-[30vw] text-left font-semibold text-white'}>
            Attention, vous allez passer en direct et votre localisation sera partagée.
          </p>
        </div>
        <p className={'w-full rounded-b-lg bg-[#A91208] py-4 font-bold text-white'}>Lancer la diffusion en direct</p>
      </button>
    </div>
  );
}
