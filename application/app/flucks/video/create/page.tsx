            ...
            <div className={'flex w-full justify-center'}>
                <div className={'flex flex-row justify-between'}>
                    ...
                    <div className={'flex flex-col items-center'}>
                        <div
                            className={'flex min-h-[75px] min-w-[150px] items-center justify-center rounded-xl bg-[#5DA5B3]'}>
                    ...
                    </div>
                    {
                        infoMissing && (
                            <div className={'mt-4'}>
                                <label className={'text-red-700 font-semibold'}>Il faut au minimum un titre et une
                                    vidéo.</label>
                            </div>
                        )
                    }
